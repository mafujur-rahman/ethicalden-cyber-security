...
export const Navbar = () => {
    ...
    // Smooth scrolling to section by ID
    ...
    return (
        <header ref={navbarRef} className="fixed top-0 left-0 right-0 z-50 mx-6 md:mx-12 opacity-0">
            <div
                className="relative h-20 mt-4 flex items-center justify-between "
            ...
            >
                ...
                <div className="hidden lg:flex items-center absolute left-1/2 transform -translate-x-1/2">
                    <div
                        className="px-6 py-2 rounded-full border border-white/10 backdrop-blur-md bg-white/10 shadow-lg"
                    >
