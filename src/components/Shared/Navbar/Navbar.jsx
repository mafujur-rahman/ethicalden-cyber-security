    ...
    >
      <div className="relative h-20 mt-4 flex items-center justify-between ">
        ...
        <button
          ...
          className="hidden lg:flex px-6 py-2  text-xs md:text-xs lg:text-[16px] xl:text-xl text-black bg-[#a8ff57] hover:bg-[#09e5e5] hover:text-black transition rounded-full font-semibold"
        >
          CONTACT US
        ...
        >
          <div className="w-8 h-8 relative">
            <span
              className={`absolute block w-full h-0.5 bg-white transform transition duration-300 ease-in-out ${
